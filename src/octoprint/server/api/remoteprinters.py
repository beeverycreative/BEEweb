...
@api.route("/remote/<string:slicer>/profiles", methods=["GET"])
...
@api.route("/remote/<string:slicer>/profiles/<string:name>", methods=["GET"])
...
@api.route("/remote/<string:slicer>/profiles/<string:name>", methods=["PUT"])
@restricted_access
...
@api.route("/remote/<string:slicer>/profiles/<string:name>", methods=["PATCH"])
@restricted_access
...
@api.route("/remote/<string:slicer>/profiles/<string:name>", methods=["DELETE"])
@restricted_access
