...
##JUNCTION_DEVIATION=0.05                      ## -> valor para o firmware BEEVC-BEETHEFIRST-10.5.48
##MINIMUM_PLANNER_SPEED=0.00                   ## -> também p/ o 10.5.48.
JUNCTION_DEVIATION=0.5                      ## -> valor para o firmware BEEVC-BEETHEFIRST-10.5.50
MINIMUM_PLANNER_SPEED=0.5                   ## -> também p/ o 10.5.50.
MAX_FEED_X=60000.0
MAX_FEED_Y=60000.0
MAX_FEED_Z=60000.0
MAX_FEED_E0=60000.0
